...
export default function AdminNewProductPage() {
    ...
    const handleImageSelect = (e) => {
        ...
        const newImages = files.map((file) => ({
            ...
            isPrimary: images.length === 0 && imageFiles.length === 0,
        }));
        ...
        try {
            ...
            submitData.append("data", JSON.stringify({
                ...
                variants: variants.map((v) => ({
                    ...
                    availableStock: parseInt(v.availableStock || v.stock, 10) || 0,
        ...
        <div className="space-y-6">
            ...
            <div className="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p className="text-muted mt-1">Tạo sản phẩm với các biến thể và hình ảnh</p>
                </div>
            </div>
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            onChange={(e) => {
                                                ...
                                                handleVariantChange(index, "stock", val);
                                                handleVariantChange(index, "availableStock", val);
                                            }}
                                            placeholder="0"
                                            min="0"
                                            className="w-full px-3 py-2 text-sm bg-background border border-border rounded-lg text-foreground focus:outline-none focus:border-accent"
