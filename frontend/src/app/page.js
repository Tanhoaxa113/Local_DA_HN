...
// Hàm lấy danh sách sản phẩm mới về
...
// Dữ liệu cho phần tính năng nổi bật
const features = [
  {
    icon: TruckIcon,
...
// Ảnh mặc định cho danh mục nếu thiếu
 ...
 * 
 * Chức năng:
 * - Hiển thị banner (Hero section)
 * - Hiển thị các tính năng nổi bật (Features)
 * - Danh sách danh mục sản phẩm (Categories)
 * - Sản phẩm nổi bật (Featured Products)
 * - Banner khuyến mãi (Sale Banner)
 * - Sản phẩm mới về (New Arrivals)
 * 
 * Data Fetching:
 * - Server Components fetching data trực tiếp từ API
 * - Sử dụng Promise.all để fetch song song tối ưu hiệu suất
 */
export default async function HomePage() {
  // Fetch real data from API
  // Gọi API lấy dữ liệu thực tế: sản phẩm nổi bật, hàng mới, danh mục
  ...
  // Thêm ảnh mặc định cho danh mục nếu chưa có
